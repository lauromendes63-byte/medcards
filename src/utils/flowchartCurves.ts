...
export const FLOWCHART_THEMES: Record<FlowchartThemeId, FlowchartThemeConfig> = {
  ...
  light: {
    ...
    bannerBorder: 'border-slate-200 shadow-sm',
    cardBgClass: 'bg-white',
    cardBorderClass: 'border-slate-200/90',
    ...
    hiddenCardBgClass: 'bg-gradient-to-b from-white via-white to-blue-50/30',
    hiddenCardBorderClass: 'border-blue-400/90 hover:border-blue-500',
    hiddenCardTitleClass: 'text-slate-900 font-bold',
    hiddenCardDescClass: 'text-slate-600',
    hiddenCardButtonClass: 'bg-blue-600 hover:bg-blue-700 active:bg-blue-800 text-white font-black shadow-sm shadow-blue-500/25',
